    ...
    <div className="">
      ...
      <div className="flex w-screen flex-col items-center gap-2 border-b-2 bg-green-200 p-5 md:p-20 dark:bg-slate-700">
        <p className="mb-2 text-gray-500 dark:text-gray-400">
          ...
          offers a wide range of resources designed to support students at every
          stage of their academic journey. With interactive lessons, study
          materials, and collaborative tools, we make learning a personalized
          experience that’s both comprehensive and enjoyable.
        </p>
        <p className="mb-2 text-gray-500 dark:text-gray-400">
          Why Choose LearnHub?
        </p>
        ...
        <form className="mx-auto flex w-full flex-col items-center md:w-1/2 md:flex-row">
          <div className="relative w-full">
            <input
              ...
              placeholder="Search for tutorials, tutors... eg: Artificial Intelligence"
              required
            />
          </div>
          <button
            type="submit"
            className="m-2 inline-flex items-center rounded-lg border border-blue-700 bg-blue-700 px-3 py-2.5 text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
          >
            <svg
        ...
        <Label className="">
          <a
            className="flex text-lg text-blue-700 dark:text-slate-400 dark:underline"
            href="#"
          >
